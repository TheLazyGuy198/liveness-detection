...
def get_state_dict():
    pretrained_model_path = '/home/minh/liveness-detection/weights/resnet50_imagnet_pretrain.pth'
    save_model_path = '/home/minh/liveness-detection/weights/hfn_pretrain.pth'
